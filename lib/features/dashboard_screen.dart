...
//     setState(() {
//       todaySteps = todayRecord.isNotEmpty ? todayRecord.first.steps : 0;
//       todayCalories = todayRecord.isNotEmpty ? todayRecord.first.calories : 0;
//       todayWater = todayRecord.isNotEmpty ? todayRecord.first.water : 0;
//     });
//   }

//   /// 🔥 NEW FUNCTION – Loads last 7 days of steps
...
//       final formatted = DateFormat("MM/dd/yyyy").format(day);

//       final data = records.where((rec) => rec.date == formatted).toList();
//       last7Days.add(data.isNotEmpty ? data.first.steps : 0);
//     }

//     setState(() {
//       weeklySteps = last7Days;
//     });
//   }
...
//   // Screens under bottom nav
//   List<Widget> get _screens => [
//     DashboardHome(
//       steps: todaySteps,
//       calories: todayCalories,
//       water: todayWater,
//       onRefresh: _loadTodayActivity,
//     ),
//     const RecordsScreen(),
//     const ProfilePage(),
//   ];
...
//             MaterialPageRoute(builder: (_) => const AddHealthRecordScreen()),
//           );
//           onRefresh(); // Refresh today's activity when coming back
//         },
//         child: const Icon(Icons.add, size: 28),
//       ),
//     );
